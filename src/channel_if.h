                                   ...
                                   int dir)
{
	...
	rc = ((channel_init_t *) _m)(obj, devinfo, b, c, dir);
	return (rc);
}
...
static __inline int CHANNEL_RESET(kobj_t obj, void *data)
{
	...
	rc = ((channel_reset_t *) _m)(obj, data);
	return (rc);
}
...
static __inline int CHANNEL_RESETDONE(kobj_t obj, void *data)
{
	...
	rc = ((channel_resetdone_t *) _m)(obj, data);
	return (rc);
}
...
static __inline int CHANNEL_SETFORMAT(kobj_t obj, void *data, u_int32_t format)
{
	...
	rc = ((channel_setformat_t *) _m)(obj, data, format);
	return (rc);
}
                                           ...
                                           u_int32_t speed)
{
	...
	rc = ((channel_setspeed_t *) _m)(obj, data, speed);
	return (rc);
}
                                               ...
                                               u_int32_t blocksize)
{
	...
	rc = ((channel_setblocksize_t *) _m)(obj, data, blocksize);
	return (rc);
}
                                         ...
                                         u_int32_t blockcount)
{
	...
	rc = ((channel_setfragments_t *) _m)(obj, data, blocksize, blockcount);
	return (rc);
}
...
static __inline int CHANNEL_TRIGGER(kobj_t obj, void *data, int go)
{
	...
	rc = ((channel_trigger_t *) _m)(obj, data, go);
	return (rc);
}
...
static __inline u_int32_t CHANNEL_GETPTR(kobj_t obj, void *data)
{
	...
	rc = ((channel_getptr_t *) _m)(obj, data);
	return (rc);
}
...
{
	kobjop_t _m;
	struct pcmchan_caps* rc;
	KOBJOPLOOKUP(((kobj_t)obj)->ops,channel_getcaps);
	rc = ((channel_getcaps_t *) _m)(obj, data);
	return (rc);
}
...
static __inline int CHANNEL_NOTIFY(kobj_t obj, void *data, u_int32_t changed)
{
	...
	rc = ((channel_notify_t *) _m)(obj, data, changed);
	return (rc);
}
                                     ...
                                     int *rpeak)
{
	...
	rc = ((channel_getpeaks_t *) _m)(obj, data, lpeak, rpeak);
	return (rc);
}
...
static __inline int CHANNEL_GETRATES(kobj_t obj, void *data, int **rates)
{
	...
	rc = ((channel_getrates_t *) _m)(obj, data, rates);
	return (rc);
}
...
{
	kobjop_t _m;
	struct pcmchan_matrix * rc;
	KOBJOPLOOKUP(((kobj_t)obj)->ops,channel_getmatrix);
	rc = ((channel_getmatrix_t *) _m)(obj, data, format);
	return (rc);
}
                                      ...
                                      struct pcmchan_matrix *m)
{
	...
	rc = ((channel_setmatrix_t *) _m)(obj, data, m);
	return (rc);
}
